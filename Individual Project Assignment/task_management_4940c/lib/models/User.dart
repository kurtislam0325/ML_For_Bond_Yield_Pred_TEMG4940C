...
class User extends amplify_core.Model {
  ...
  const User._internal({required this.id, ToDos, password, email, createdAt, updatedAt}): _ToDos = ToDos, _password = password, _email = email, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory User({String? id, List<ToDo>? ToDos, String? password, String? email}) {
  ...
  User copyWith({List<ToDo>? ToDos, String? password, String? email}) {
    return User._internal(
      id: id,
  ...
  User copyWithModelFieldValues({
    ModelFieldValue<List<ToDo>?>? ToDos,
    ModelFieldValue<String?>? password,
    ModelFieldValue<String?>? email
  }) {
    return User._internal(
      id: id,
      ToDos: ToDos == null ? this.ToDos : ToDos.value,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'ToDos': _ToDos?.map((ToDo? e) => e?.toJson()).toList(), 'password': _password, 'email': _email, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final TODOS = amplify_core.QueryField(
    fieldName: "ToDos",
