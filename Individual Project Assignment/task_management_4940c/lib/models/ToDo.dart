...
class ToDo extends amplify_core.Model {
  ...
  const ToDo._internal({required this.id, status, title, description, priority, required userID, createdAt, updatedAt}): _status = status, _title = title, _description = description, _priority = priority, _userID = userID, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory ToDo({String? id, Status? status, String? title, String? description, int? priority, required String userID}) {
  ...
  ToDo copyWith({Status? status, String? title, String? description, int? priority, String? userID}) {
    return ToDo._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'status': amplify_core.enumToString(_status), 'title': _title, 'description': _description, 'priority': _priority, 'userID': _userID, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
